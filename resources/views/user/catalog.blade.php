...
<head>
    ...
    <title>Katalog {{ $categoryNameLabel ?? 'Aset' }} - Nexus Inventory</title>
        ...
        <aside class="w-64 bg-gradient-to-b from-nexus-dark to-black text-white flex flex-col flex-shrink-0">
            ...
            <nav class="px-3 py-4 space-y-1 flex-1 overflow-y-auto">
                ...
                <div class="mt-4">
                    ...
                    <!-- KATALOG ASET DENGAN DROPDOWN (AKTIF) -->
                    <div>
                        <button onclick="toggleKatalog()" type="button" class="w-full flex items-center gap-3 px-4 py-3 bg-white/10 text-white rounded-lg transition text-left">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path>
                            </svg>
                            <span class="text-sm flex-1">Katalog aset</span>
                            <svg id="katalog-arrow" class="w-4 h-4 transition-transform duration-300 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        
                        <div id="katalog-submenu" class="pl-12 space-y-1 mt-1">
                            <a href="{{ route('katalog.category', 'hp-smartphone') }}" class="block px-4 py-2 text-sm {{ request()->is('katalog/hp-smartphone') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }} rounded-lg transition">HP & Smartphone</a>
                            <a href="{{ route('katalog.category', 'laptop') }}" class="block px-4 py-2 text-sm {{ request()->is('katalog/laptop') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }} rounded-lg transition">Laptop</a>
                            <a href="{{ route('katalog.category', 'kamera') }}" class="block px-4 py-2 text-sm {{ request()->is('katalog/kamera') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }} rounded-lg transition">Kamera</a>
                            <a href="{{ route('katalog.category', 'playstation') }}" class="block px-4 py-2 text-sm {{ request()->is('katalog/playstation') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }} rounded-lg transition">PlayStation</a>
                        </div>
                    </div>
