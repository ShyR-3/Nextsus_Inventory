    ...
    <img src="{{ asset('foto/playstation.png') }}" 
        ...
        <div class="w-full lg:w-1/2 bg-nexus-darker p-8 lg:p-16 flex items-center justify-center">
            <div class="w-full max-w-md">
                ...
                <!-- Google Login -->
                <button type="button" class="w-full flex items-center justify-center gap-3 bg-white text-gray-700 font-semibold py-3 rounded-xl hover:bg-gray-50 transition duration-300">
                ...
                <p class="mt-8 text-center text-sm text-gray-400">
                    Belum punya akun? <a href="#" class="text-white font-semibold hover:underline">Daftar di sini</a>
                </p>
            </div>
        </div>
